...
Revision ID: 34892d95fb13
Revises: 
Create Date: 2026-02-08 00:31:32.545944
...
def upgrade():
    ...
    with op.batch_alter_table('voter_tokens', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_voter_tokens_poll_id'), ['poll_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('voter_tokens', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_voter_tokens_poll_id'))
